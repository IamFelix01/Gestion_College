...
public class EmploiController implements Initializable {
    ...
    public void addStudentsShowListData() {
        String sql = "SELECT Cours.nom, enseignant.nom FROM Cours, enseignant where Cours.enseignant = enseignant.id And HeureDebut = ? and jour = ? and Cours.Classe = ?";
